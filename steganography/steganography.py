...
encbutton=Button(text='Encode',fg="white",bg="purple",width=20,command=encode)
encbutton['font'] =fontl 
encbutton.place(relx=0.6,rely=0.3)


decbutton=Button(text='Decode',fg="white",bg="purple",width=20,command=decode)
...
closebutton=Button(text='EXIT',fg="white",bg="purple",width=20,command=exit)
